...
public final class AMeigSimboloLogica extends PSimboloLogica
{
    private TMenorigual _menorigual_;

    public AMeigSimboloLogica()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAMeigSimboloLogica(this);
    }
