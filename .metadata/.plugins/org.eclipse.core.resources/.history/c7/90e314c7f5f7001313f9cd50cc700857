...
public final class AMaigSimboloLogica extends PSimboloLogica
{
    private TMaiorigual _maiorigual_;

    public AMaigSimboloLogica()
    {
        // Constructor
    }
    ...
    {
        ((Analysis) sw).caseAMaigSimboloLogica(this);
    }
